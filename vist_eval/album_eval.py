__author__ = 'Licheng'
import sys
sys.path.append('C:/Not_Windows/AREL-master/vist_eval/tokenizer')
from pprint import pprint
from ptbtokenizer import PTBTokenizer
sys.path.append('C:/Not_Windows/AREL-master/vist_eval/bleu')
from bleu import Bleu
sys.path.append('C:/Not_Windows/AREL-master/vist_eval/meteor')

from meteor import Meteor
sys.path.append('C:/Not_Windows/AREL-master/vist_eval/rouge')
from rouge import Rouge
sys.path.append('C:/Not_Windows/AREL-master/vist_eval/cider')
